module.exports = class Data1714409349769 {
    name = 'Data1714409349769'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "cluster" ("id" character varying NOT NULL, "p_init" integer NOT NULL, "worker" integer NOT NULL, "idle_worker" integer NOT NULL, "stake" numeric NOT NULL, "staker" integer NOT NULL, "contract" integer NOT NULL, "created_time" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_b09d39b9491ce5cb1e8407761fd" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "contract" ("id" character varying NOT NULL, "stake" numeric NOT NULL, "staker" integer NOT NULL, "instantiated_time" TIMESTAMP WITH TIME ZONE NOT NULL, "deployer_id" character varying, "cluster_id" character varying, CONSTRAINT "PK_17c3a89f58a2997276084e706e8" PRIMARY KEY ("id"))`)
